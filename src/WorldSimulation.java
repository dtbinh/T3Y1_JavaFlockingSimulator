...
/**
 * <h1>WorldSimulation</h1> This class represents a "world" for boids to live
 * in.
 *
 * @author Y3508038
 * @version 1.0
...
public class WorldSimulation {
	...
	/**
	 * Constructor which sets up communication between <code>this</code> and the
	 * menu/boid-panel. Listeners for resizing and mouse actions are set up.
	 * After initiating communication, the timer is set up.
	 * 
	 * @param boidPanel
	 *            A boidPanel to interact with
	 * @param menuPanel
	 *            A menuPanel to interact with
	 */
	...
	/**
	 * Creates n boids placed randomly within the range of the boidPanels size,
	...
	/**
	 * Instantiates a boid with coordinates x and y. Also sets the
	 * influence-sliders values of each boid to the actual slider-value
	 * 
	 * @param x
	 *            Used as x-coordinate
	 * @param y
	 *            Used as y-coordinate
	 */
	...
	/**
	 * Setting up the boidPanel's mouse listener. Only mouseClicked is
	 * implemented. When mouse is clicked: Create boid with at mouse coordinates
	 */
	...
	/**
	 * Setting up a timer that fires an event every time interval A inner class
	 * is ran every time the event fires Inner class: Update world and repaint
	 * boidPanel
	 */
	...
	/**
	 * Updates world by updating position, neighbors and velocities for each
	 * boid
	 */
	...
	private void updateNeighbors() {
		for (Boid boid : boidList) {
			boid.calculateVisibleBoids(this.boidList);
		}
	}
	...
	/**
	 * Returns a boolean variable where the timer is either running(true) or not
	 * running(false)
	 * 
	 ...
	 ***********************************************/
	/**
	 * Sets the desired update rate of the timer (and thus the desired FPS of
	 * the graphics)
	 * 
	 * @param FPS
	...
	/**
	 * Sets the influence rate of separation equal to
	 * <code>influenceGrade / 100</code>
	 * 
	 * @param influenceGrade
	 *            Grade of influence
	 */
